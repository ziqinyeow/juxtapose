...
from rtm.trackers.boxmot.utils import BOXMOT
...
def create_tracker(tracker_type, tracker_config, reid_weights, device, half, per_class):
    ...
    if tracker_type == "strongsort":
        ...
        from rtm.trackers.boxmot.trackers.ocsort.ocsort import OCSort
    ...
    #     return botsort
        ...
        from rtm.trackers.boxmot.trackers.deepocsort.deep_ocsort import DeepOCSort
