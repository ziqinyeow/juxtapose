...
class PipelineCaller:
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        do_multiprocess = (
            self.is_multiprocess_available
        ...
        logger.log(self._log_level, f"Start pipeline {self._func_name} in {mp_log_str}")
        ...
        assert func is not None, f"Can not find implementation of {self._func_name}"
...
class PipelineManager:
    ...
    def get_caller(self, func_name: FUNC_NAME_TYPE) -> PipelineCaller:
        ...
        assert func_name in self._callers, f"{func_name} has not been registered."
        return self._callers[func_name]

    def __set_caller_val(
        self, val_name: str, val: Any, func_name: Optional[FUNC_NAME_TYPE] = None
    ) -> None:
    ...
    def _enable_multiprocess_single(
        self, val: bool, func_name: FUNC_NAME_TYPE = None
    ) -> None:
    ...
    def enable_multiprocess(
        self,
        val: bool,
        func_names: Optional[Union[FUNC_NAME_TYPE, Sequence[FUNC_NAME_TYPE]]] = None,
    ) -> None:
    ...
    def set_mp_async(
        self, val: bool, func_name: Optional[FUNC_NAME_TYPE] = None
    ) -> None:
    ...
    def call_function_local(self, func_name: FUNC_NAME_TYPE, *args, **kwargs) -> Any:
    ...
    def call_function_async(self, func_name: FUNC_NAME_TYPE, *args, **kwargs) -> int:
        """call pipeline function.
    ...
    def register_pipeline(
        self, is_multiprocess_available: bool = True, log_level: int = logging.DEBUG
    ):
