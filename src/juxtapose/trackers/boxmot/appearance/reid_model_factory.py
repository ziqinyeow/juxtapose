...
def load_pretrained_weights(model, weight_path):
    ...
    Examples::
        >>> from juxtapose.trackers.boxmot.appearance.backbones import build_model
        >>> from juxtapose.trackers.boxmot.appearance.reid_model_factory import load_pretrained_weights
